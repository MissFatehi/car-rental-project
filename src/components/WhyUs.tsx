const WhyUs = ()=>{
    ...
    <div className="text-white">
        ...
        <button className="px-6 py-2 bg-white text-blue-600 hover:bg-slate-100 transition-all text-primary rounded-lg text-sm mt-4 cursor-pointer">List your car</button>
        </div>
        <img alt="car" className="max-h-45 mt-10" src="../banner_car_2.png"/>
        </div>
        </section>
    )
}
